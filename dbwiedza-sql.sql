...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 29, 2023 at 10:56 PM
...
(3, 1, 'teste ISSO', '2020-01-08', '23:59:59', 3);
...
(8, 'usuario.padrao', 'password'),
(9, 'fada.morgana', 'abracadabra'),
(10, 'wiedza', 'dynia123'),
(13, 'marcos.andrade', 'default'),
(14, 'didi', 'default'),
(15, 'antonio.aguiar', 'default'),
(17, 'pedro.dias', 'pedro_didias'),
(18, 'paulo.freitas', 'freitas999'),
(19, 'leandro.mortifero', 'leo%%%'),
(25, 'valentina.valente', '12345679887'),
(26, 'emanuel.carlos', '12345678951');
...
(1, 3, 'Alexandre Ferreira', '2013-05-09', 13276925036, 'DIRECTION', 'Diretor Geral', 35780, 20, 'Rua dos Elefantes', 'Bairro do Barro', '106', 39402123, 38999045566, 38998981232),
(2, 2, 'Maicon Leles', '2004-05-25', 95807787013, 'SECRETARIAT', 'Secretário Chefe', 6750, 60, 'Rua Francisco de Assis', 'Santa Verônica', '500', 3940012, 999213087, 0),
(3, 4, 'Ivanderley Oliveira', '1995-06-07', 57394927008, 'COORDENATION', 'Coordenador de Ensino', 7880, 40, 'Avenida Sanitária', 'Distrito Sanitário', '334', 3940055, 38999127639, 0),
(5, 6, 'Catarina Soares Almeida', '1979-01-08', 18141183060, 'TEACHING', 'Professora de Português', 3990, 20, 'Avenida Dissertativa', 'Bairro Acentuado', '100', 3940050, 38990405060, NULL),
(6, 9, 'Morgana', '0140-02-29', 0, 'OTHER', 'Fada Madrinha', 7777, 7, 'Absolutnie magiczna ulica', 'Zaczarowana i piękna okolica', '777', 77777777, 77777777777, 77777777778),
(7, 10, 'Karol Wiedza', '1953-03-14', 52487244062, 'DIRECTION', 'Fundador', 13200, 5, 'Ulica mądrości', 'Wielka księga', '175', 10020030, 38912428647, NULL),
(10, 10, 'Marcos Andrade', '1997-03-02', 42427848050, 'TEACHING', 'Professor de Educação Física', 1400, 20, 'Rua Leopoldo Martins', 'Centro', '143', 39333000, 38991232123, 0);
...
(3, 'Sala de Aula 1', 30, 20, 'Equipada com: \n- 30 carteiras, \n- um quadro branco,\n- mesa do professor.'),
...
(11, 'Auditório I', 310, 445, '300 cadeiras, um projetor de alta capacidade, caixas de som.'),
(12, 'Auditório II', 250, 36, '- 250 cadeiras; \n- um projetor de alta capacidade;\n- caixas de som.'),
(13, 'Laboratório de Informática', 40, 230, 'Possui 40 computadores de tipo desktop. \nUma mesa central com 40 cadeiras. \nPossui 2 quadros brancos e um dispositivo de datashow.\r\nOs computadores possuem conexão à Internet e também softwares educacionais variados.'),
(14, 'Laboratório de Química', 30, 200, 'Possui diversas bancadas com pias e torneiras de água destilada. \n\nPossui também armários com diversas vidrarias típicas das práticas laboratoriais de química \n(tubos de ensaio, erlenmeyers, béqueres, buretas, pipetas, balões de fundo chato e redondo etc.). \n\nO laboratório é provido também de equipamentos importantes como balanças de precisão, deionizadores, filtros, \nagitadores, aquecedores, almofarizes, bicos de Bunsen, capelas, microscópios, pHmetros, condensadores e até mesmo um espectrofotômetro. \r\n\r\nO laboratório pode servir também para aulas práticas de biologia, pois possui lâminas preparadas para observação no microscópio. Também estão presentes modelos anatômicos e espécimes diversas.'),
...
(16, 'Pátio', 85, 50, 'O pátio possui uma bela fonte de água potável e diversos pés de carambola. \nExistem vários bancos espalhados pelo pátio.'),
...
(5, 7, '2023-05-26', 'Faltou à aula de marcos'),
(6, 8, '2002-02-02', 'lalallaallala lalalalal alalalalla lalaalal laalal\n'),
(7, 3, '2002-06-06', 'BAteu no professor');
...
(3, 11, 'FRIDAY', '15:20:00', 2),
(4, 16, 'THURSDAY', '16:00:00', 3);
...
(1, 8, 'Joaquim Ferreira dos Santos', '1990-05-23', 11111, 'street', 'district', 'number', 12, 1, 2, 0),
(2, 8, 'Anne Carolaine', '2023-05-18', 0, '22', '33', '11', 0, 1, 2, 1),
(3, 8, 'Joaquina dos Santos', '2023-05-19', 817674740, 'Street 60', 'The district', 'Number 86', 952160, 0, -9223372036854775808, 1),
(4, 8, 'Godofredo Pereira', '1970-01-01', 5457476143, 'Street 23', 'The district', 'Number 76', 273986, 0, 0, 1),
(5, 8, 'Anafreda Tâmara', '1970-01-01', 3368406192, 'Street 58', 'The district', 'Number 4', 46731, 0, -9223372036854775808, 1),
(6, 8, 'Longo Manuel', '1970-01-01', 4046129653, 'Street 0', 'The district', 'Number 71', 132644, 0, -9223372036854775808, 1),
(7, 2, 'Pedro Dias', '2002-04-18', 92902597987, 'Rua Sinabrio', 'Monte Carmelo 2', '401', 40230025, 38997987987, 0, 1),
(8, 8, 'Flavio Rodrigo', '2002-09-04', 8649505511, 'Av. Rui de Albuquerque', 'Planalto', '1052', 39404046, 999685478, 0, 1),
(10, 25, 'Valentina Valente', '2005-08-19', 12345679887, 'Rua h', 'Santa Maria', '123A', 39987845, 38998754654, 0, 1),
(11, 26, 'Emanuel Carlos', '2000-09-04', 12345678951, 'Rua liasasd', 'Bairro laallalla', '321A', 13216545, 38987546512, 0, 1);
...
(49, 'ingles', 'ING010', 40, 'ingles instrumental II', NULL);
